...
config.General.requestName = 'OffsetTreeMaker_Data_Run2024G-nib2-PromptReco-v1-withbpixveto'      #change
config.General.workArea = 'crab_projects/Data/Run2024G-nib2-PromptReco-v1-withbpixveto'       #change
#config.General.requestName = 'OffsetTreeMaker_Data_Run2024F-PromptReco-v1-withbpixveto-lumibx-part1'      #change
#config.General.workArea = 'crab_projects/Data/Run2024F-PromptReco-v1-withbpixveto-lumibx-part1'       #change
#config.General.requestName = 'OffsetTreeMaker_MC_Run3Summer24DRPremix'      #change
#config.General.workArea = 'crab_projects/MC/Run3Summer24DRPremix'       #change
...
config.JobType.inputFiles = ["pileup_2024_1010.txt", "jetveto2024BCDE_FG_FPix_V6M.root"] #,"lumi-per-bx_Run2024I-part1.root"]      #change
config.JobType.outputFiles = ["Offset_Run3_Data_Run2024G-nib2.root"]                                   #change

config.section_("Data")
config.Data.allowNonValidInputDataset = True
config.Data.inputDataset = '/ZeroBias/Run2024G-PromptReco-v1/AOD'     #change
...
config.Data.lumiMask = '2024G-nib2_Golden.json'                                                         #change
config.Data.unitsPerJob = 100
config.Data.outLFNDirBase = '/store/user/hbandyop/Run3_L1Offset/Data_with_depth/Run2024G-nib2-PromptReco-v1-withbpixveto'     #change
#config.Data.outLFNDirBase = '/store/user/hbandyop/Run3_L1Offset/MC_New/Run3Summer24DRPremix'             #change
