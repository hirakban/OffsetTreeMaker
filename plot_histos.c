...
*/
	...
	text.DrawLatex(0.2, 0.86, "#sigma_{MB} = 75.3 mb");

	TLegend* leg = new TLegend(.45,.8,.9,.92);
	leg->SetBorderSize(0);
	leg->SetFillColor(0);
	leg->SetFillStyle(0);
...
//	leg->AddEntry(npu_data,Form("Data (Mean %2.2f)", mean_data));
	leg->AddEntry(npu,Form("MC: Summer24 (Mean %2.2f)", mean_mc));
//	leg->AddEntry(npu,Form("Data: Run2024I (Mean %2.2f)", mean_mc));
	leg->AddEntry(npu_data,Form("Data: Run2024C (Mean %2.2f)", mean_data));
//	leg->AddEntry(npu,Form("Data:2024I-lumibxPU (Mean %2.2f)", mean_mc));
//	leg->AddEntry(npu_data,Form("Data:2024I-AvgPU (Mean %2.2f)", mean_data));
...
*/
	...
	TLegend* leg2 = new TLegend(.45,.8,.9,.92);
	...
	text2.DrawLatex(0.55, 0.96, label );
	
//	leg2->AddEntry(npv,Form("MC (Mean %2.2f)", npv_mean_mc));
//	leg2->AddEntry(npv_data,Form("Data (Mean %2.2f)", npv_mean_data));
	leg2->AddEntry(npv,Form("MC: Summer24 (Mean %2.2f)", npv_mean_mc));
//	leg2->AddEntry(npv,Form("Data: Run2024I (Mean %2.2f)", npv_mean_mc));
	leg2->AddEntry(npv_data,Form("Data: Run2024C (Mean %2.2f)", npv_mean_data));
//	leg2->AddEntry(npv,Form("Data:2024I-lumibxPU (Mean %2.2f)", npv_mean_mc));
//	leg2->AddEntry(npv_data,Form("Data:2024I-AvgPU (Mean %2.2f)", npv_mean_data));
...
*/
	...
	TLegend* leg3 = new TLegend(.45,.8,.9,.92);
	...
	text3.DrawLatex(0.55, 0.96, label );
	
//	leg3->AddEntry(rho,Form("MC (Mean %2.2f)", rho_mean_mc));
//	leg3->AddEntry(rho_data,Form("Data (Mean %2.2f)", rho_mean_data));
	leg3->AddEntry(rho,Form("MC: Summer24 (Mean %2.2f)", rho_mean_mc));
//	leg3->AddEntry(rho,Form("Data: Run2024I (Mean %2.2f)", rho_mean_mc));
	leg3->AddEntry(rho_data,Form("Data: Run2024C (Mean %2.2f)", rho_mean_data));
//	leg3->AddEntry(rho,Form("Data:2024I-lumibxPU (Mean %2.2f)", rho_mean_mc));
//	leg3->AddEntry(rho_data,Form("Data:2024I-AvgPU (Mean %2.2f)", rho_mean_data));
